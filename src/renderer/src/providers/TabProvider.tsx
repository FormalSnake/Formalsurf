    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <span
            className={`truncate flex-grow transition-all duration-300 ease-in-out`}
            style={{ marginRight: textMargin() }}
          >
            {tab.title}
          </span>
          {isHovered && (
            <div className="flex space-x-1 absolute right-0 mr-2 transition-opacity duration-300">
